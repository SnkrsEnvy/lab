...
import z6a1 from './cover-parts/z6a1.js';
import z6a2 from './cover-parts/z6a2.js';
import z6b from './cover-parts/z6b.js';
export default function handler(req,res){const parts={z1a,z1b,z2,z3a,z3b,z4,z5a,z5b,z6a1,z6a2,z6b};res.status(200).json({lengths:Object.fromEntries(Object.entries(parts).map(([k,v])=>[k,v.length])),total:Object.values(parts).join('').length});}
