...
export default function handler(req,res){const parts={z1a,z1b,z2,z3a,z3b,z4,z5a,z5b,z6a,z6b};res.status(200).json({lengths:Object.fromEntries(Object.entries(parts).map(([k,v])=>[k,v.length])),total:Object.values(parts).join('').length});}
