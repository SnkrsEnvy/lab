...
const TOOLS=['replaceText','redact','ocr','forms','links','moveImage','resizeImage','rotateImage','deleteImage','replaceImage','pageReorder','pageInsert','pageDelete','undo','exportPdf'];
let adapter=null;
