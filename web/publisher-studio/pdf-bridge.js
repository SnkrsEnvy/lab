...
const TOOLS=['replaceText','redact','ocr','forms','links','moveImage','resizeImage','rotateImage','deleteImage','replaceImage','insertImage','pageReorder','pageInsert','pageDelete','undo','exportPdf'];
let adapter=null;
